...
int main()
{
	...
	if (OutQueue(&QQ, &ee) == 9)  printf("出队的元素值为%d\n", ee);
	if (OutQueue(&QQ, &ee) == 1)  printf("出队的元素值为%d\n", ee);
	if (OutQueue(&QQ, &ee) == 7)  printf("出队的元素值为%d\n", ee);
	if (OutQueue(&QQ, &ee) == 1)  printf("出队的元素值为%d\n", ee);
	if (OutQueue(&QQ, &ee) == 5)  printf("出队的元素值为%d\n", ee);
	if (OutQueue(&QQ, &ee) == 1)  printf("出队的元素值为%d\n", ee);
...
int InQueue(PSeqQueue QQ, ElemType *ee)
{
	...
	memcpy(&QQ->data[QQ->rear], ee, sizeof(ElemType));//数组下标运算
...
int OutQueue(PSeqQueue QQ, ElemType *ee)
{
	...
	memcpy(ee, &QQ->data[QQ->front], sizeof(ElemType));//数组下标访问
	memcpy(ee, QQ->data + QQ->front, sizeof(ElemType));//指针访问
...
int GetHead(PSeqQueue QQ, ElemType *ee)
{
	...
	memcpy(ee, &QQ->data[QQ->front], sizeof(ElemType));//用数组下标访问
